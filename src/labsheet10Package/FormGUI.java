...
public class FormGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jList1.getAccessibleContext().setAccessibleParent(jScrollBar1);
        ...
        jScrollBar1.getAccessibleContext().setAccessibleParent(jList1);

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int indexnumber=Integer.valueOf(jTextField1.getText());
       ...
       i.insert( indexnumber,name,subject1,subject2,subject3,gpa);
 ...
 System.out.println(e.getMessage()); 
    ...
    public static void main(String args[]) throws ClassNotFoundException, SQLException {
        ...
        CreateDB db= new CreateDB();
         db.createNewDatabase("Student details.db");
